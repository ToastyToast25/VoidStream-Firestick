...
class AppUpdater(private val context: Context) {
    ...
    private val GITHUB_RELEASES_URL = "https://api.github.com/repos/ToastyToast25/VoidStream-Firestick/releases/latest"
    ...
    suspend fun downloadAndInstall(version: String, downloadUrl: String) {
        ...
        try {
            ...
            val apkFile = File(downloadsDir, "VOIDSTREAM_${version}.apk")
